...
SRC_PKGS := *.go hack plugin-go-grpc shared # directories which hold app source excluding tests (not vendored)
...
GO_VERSION       ?= 1.12.12
BUILD_IMAGE      ?= appscode/golang-dev:$(GO_VERSION)-buster
